    ...
    public void expression(final CFExpression expression, final Context context, final BugList bugs) {
        ...
        if (context.isInAssignmentExpression() && expression instanceof CFFullVarExpression) {
            ...
            if (subExpressions != null && subExpressions.size() > offset
                ...
                context.addMessage("STRUCT_ARRAY_NOTATION",
                        subExpressions.get(subExpressions.size() - offset).Decompile(0), this, null, null,
                        subExpressions.get(subExpressions.size() - offset));
            }
            ...
            for (Object element : structExpression.getElements()) {
                ...
                if (!"'".equals(firstToken) && !"\"".equals(firstToken)) {
                    context.addMessage("UNQUOTED_STRUCT_KEY", structKeyExpression.getKey().Decompile(0), this, null,
                            null, structKeyExpression.getKey());
                }
            }
        }
    }
